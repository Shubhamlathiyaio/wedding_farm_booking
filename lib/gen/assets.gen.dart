...
class $AssetsLocalesGen {
  ...
  /// File path: assets/locales/gu.json
  String get gu => 'assets/locales/gu.json';

  /// File path: assets/locales/hi.json
  String get hi => 'assets/locales/hi.json';

  /// List of all assets
  List<String> get values => [en, gu, hi];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/ic_gallery.svg
  String get icGallery => 'assets/svg/ic_gallery.svg';

  /// List of all assets
  List<String> get values => [icCamera, icGallery];
}
